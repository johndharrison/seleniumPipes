...
#'
#'\code{findElement} Search for an element on the page, starting from the
#'    document root. The located element will be returned as an object of
#'    "wElement" class
#'
#' @template remDr
#' @param using Locator scheme to use to search the element, available
...
#'
#'\code{findElements} Search for multiple elements on the page, starting
...
#'
#'\code{findElementsFromElement} Search for multiple elements on the page,
#'    starting from the node defined by the parent webElement. The located
...
#'
#'\code{getActiveElement} Get the element on the page that currently has
